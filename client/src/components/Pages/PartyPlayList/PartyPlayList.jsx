...
cursor: pointer;
`
const PartyPlayList = ({party_songs,isMobile, color,handleData,handleDownload,selectedSong,handlePlayAll,isPlaying}) => {
 const [total,setTotal]=useState(null);
 const navigate = useNavigate();
  const { id } = useParams();
  const Filteralbum = party_songs.filter(album => album.id === id);
