...
cursor: pointer;
`
const PlayList = ({AllAlbums,isMobile,handleData,handleDownload,handlePlayAll,selectedSong,isPlaying,setIsPlaying ,color}) => {
            ...
            <Wrap key={album.id}>
              ...
              <Wrapper>
                ...
                {isPlaying ? (
                  ...
                  <PlayAll onClick={() => handlePlayAll(album.playlist)} />
                )}
              </Box>
                </ResponsiveArtistWrapper>
              </Wrapper>
